...
REGION = "global"
PROJECT_ID = "alpine-listener-509701-r8" # TODO: alpine-listener-509701-r8
...
try:
    ...
    print(f"Vertex AI client initialized for {PROJECT_ID}")
except Exception as error:
    st.error(f"Could not initialize Vertex AI: {error}")
    st.stop()
